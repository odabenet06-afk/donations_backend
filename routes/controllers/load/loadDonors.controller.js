...
import { loadDonors } from "../../models/load/loadDonors.model.js";

export async function loadDonorsController(req, res) {
  ...
  try {
    const donors = await loadDonors(year, month, search);
